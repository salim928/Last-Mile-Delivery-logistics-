            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-64 pl-10 pr-4 py-2 text-sm bg-slate-100 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
          ...
          <main className="flex-1 min-w-0">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {quickLinks.map((link) => (
                  <Link 
                    key={link.title}
                    href={link.href}
                    className="group p-6 bg-white rounded-xl border border-slate-200 hover:border-orange-300 hover:shadow-lg transition-all"
                  >
            ...
            <section className="mb-16">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/docs/api" className="text-sm font-medium text-orange-600 hover:text-orange-700 flex items-center gap-1">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {sdks.map((sdk) => (
                  <div key={sdk.name} className="p-5 bg-white rounded-xl border border-slate-200 hover:border-slate-300 transition-colors">
                    ...
                    <Link href={`/docs/sdk/${sdk.name.toLowerCase()}`} className="text-sm font-medium text-orange-600 hover:text-orange-700">
                      View documentation →
                    </Link>
                  </div>
                ))}
...
print(f"Optimized {len(routes)} routes")`}</code>
            ...
            {/* Help */}
            <section className="bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl p-8 text-white">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="flex gap-4">
                    <Link 
                      href="/help" 
                      className="px-5 py-2.5 bg-white text-orange-600 font-medium rounded-lg hover:bg-orange-50 transition-colors"
                    >
                      Help Center
                    </Link>
                    <Link 
